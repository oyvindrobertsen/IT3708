...
def log_generation(generation_number, best_fitness, average_fitness, standard_deviation, best_phenotype):
    print 'Generation', generation_number, ':', best_fitness, average_fitness, standard_deviation, best_phenotype
...
class EARunner(object):
    ...
    def __init__(self, problem=None, population_size=None, generations=None, crossover_rate=None, mutation_rate=None,
            adult_selection=None, adult_to_child_ratio=None, parent_selection=None, k=1, epsilon=0.2, crossover_function=None,
    ...
    def solve(self, **kwargs):
        ...
        for generation in range(self.generations):
            ...
            parents = [(self.select_parent(self.population, k=self.k, epsilon=self.epsilon, temperature=temperature), self.select_parent(self.population, k=self.k, epsilon=self.epsilon, temperature=temperature, **kwargs)) for _ in range(open_slots)]
